/*
{
    "appetizers": [
        "Shrimp Cocktail" {
            ...
            ["Large shrimp, sprinkled with fresh lemon juice with a zesty cocktail sauce."]
        }, 
        "Crab and Artichoke Dip" {
            ["lump crabmeat", "artichoke hearts", "cream cheese", "Monterey Jack cheese", "Parmesan cheese" "garlic", "green onions", "garlicky crostini"],
            ["Fresh Maine crab and artichoke hearts in a warm cheese sauce with garlicky crostini."]
        }, 
        "Ceviche" {
            ["halibut", "lime", "lemon", "onion", "cilantro", "chili pepper"],
            ["Chunks of fresh halibut, marinated in freshly squeezed lime and lemon juices, with chopped onions, chili peppers, cilantro, salt and pepper"]
        }]
